...
int main(int argc, char* argv[])
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    print_processes();
   6:	e8 30 03 00 00       	call   33b <print_processes>
    exit();
