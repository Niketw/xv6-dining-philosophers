   ...
   e:	bb 05 00 00 00       	mov    $0x5,%ebx
{
  ...
  23:	83 c4 10             	add    $0x10,%esp
    ...
    {
        pid[i] = fork();
  26:	e8 80 02 00 00       	call   2ab <fork>
        if(pid[i] == 0)
  2b:	85 c0                	test   %eax,%eax
  2d:	74 26                	je     55 <main+0x55>
    for(int i = 0; i < 5; i++)
  2f:	83 eb 01             	sub    $0x1,%ebx
  32:	75 f2                	jne    26 <main+0x26>
  34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    while(wait());
  38:	e8 7e 02 00 00       	call   2bb <wait>
  3d:	85 c0                	test   %eax,%eax
  3f:	75 f7                	jne    38 <main+0x38>
    printf(1, "foo terminated\n");
  41:	83 ec 08             	sub    $0x8,%esp
  44:	68 97 07 00 00       	push   $0x797
  49:	6a 01                	push   $0x1
  4b:	e8 10 04 00 00       	call   460 <printf>
    exit();
  50:	e8 5e 02 00 00       	call   2b3 <exit>
            for(long int j = 0; j < 4000000000; j++)
  55:	eb fe                	jmp    55 <main+0x55>
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 b0 07 00 00 	jmp    *0x7b0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba a7 07 00 00       	mov    $0x7a7,%edx
        while(*s != 0){
