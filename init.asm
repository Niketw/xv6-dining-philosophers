 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba b9 08 00 00       	mov    $0x8b9,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 cc 0b 00 00       	mov    0xbcc,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d cc 0b 00 00    	mov    0xbcc,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 cc 0b 00 00    	mov    0xbcc,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 cc 0b 00 00    	mov    %edx,0xbcc
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 cc 0b 00 00 d0 	movl   $0xbd0,0xbcc
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf d0 0b 00 00       	mov    $0xbd0,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 d0 0b 00 00 d0 	movl   $0xbd0,0xbd0
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 812:	00 00 00 
    if(p->s.size >= nunits){
