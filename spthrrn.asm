...
_spthrrn:     file format elf32-i386
  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  27:	e8 47 03 00 00       	call   373 <set_ptable_hrrn_priority>
 ...
 5f1:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf a4 0a 00 00       	mov    $0xaa4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 762:	00 00 00 
    if(p->s.size >= nunits){
