...
00000413 <calculate_sum_of_digits>:
 413:	b8 16 00 00 00       	mov    $0x16,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret    

0000041b <get_parent_pid>:
 41b:	b8 17 00 00 00       	mov    $0x17,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret    

00000423 <get_file_sectors>:
 423:	b8 18 00 00 00       	mov    $0x18,%eax
 428:	cd 40                	int    $0x40
 42a:	c3                   	ret    

0000042b <set_process_parent>:
 42b:	b8 19 00 00 00       	mov    $0x19,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret    

00000433 <change_process_queue>:
 433:	b8 1a 00 00 00       	mov    $0x1a,%eax
 438:	cd 40                	int    $0x40
 43a:	c3                   	ret    

0000043b <set_hrrn_priority>:
 43b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 440:	cd 40                	int    $0x40
 442:	c3                   	ret    

00000443 <set_ptable_hrrn_priority>:
 443:	b8 1c 00 00 00       	mov    $0x1c,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    

0000044b <print_processes>:
