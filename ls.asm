...
00000633 <calculate_sum_of_digits>:
 633:	b8 16 00 00 00       	mov    $0x16,%eax
 638:	cd 40                	int    $0x40
 63a:	c3                   	ret    

0000063b <get_parent_pid>:
 63b:	b8 17 00 00 00       	mov    $0x17,%eax
 640:	cd 40                	int    $0x40
 642:	c3                   	ret    

00000643 <get_file_sectors>:
 643:	b8 18 00 00 00       	mov    $0x18,%eax
 648:	cd 40                	int    $0x40
 64a:	c3                   	ret    

0000064b <set_process_parent>:
 64b:	b8 19 00 00 00       	mov    $0x19,%eax
 650:	cd 40                	int    $0x40
 652:	c3                   	ret    

00000653 <change_process_queue>:
 653:	b8 1a 00 00 00       	mov    $0x1a,%eax
 658:	cd 40                	int    $0x40
 65a:	c3                   	ret    

0000065b <set_hrrn_priority>:
 65b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 660:	cd 40                	int    $0x40
 662:	c3                   	ret    

00000663 <set_ptable_hrrn_priority>:
 663:	b8 1c 00 00 00       	mov    $0x1c,%eax
 668:	cd 40                	int    $0x40
 66a:	c3                   	ret    

0000066b <print_processes>:
