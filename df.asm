...
int main(int argc, char *argv[]) {
  ...
  29:	e8 a5 03 00 00       	call   3d3 <sem_init>
  2e:	83 c4 10             	add    $0x10,%esp
  31:	83 fb 06             	cmp    $0x6,%ebx
  34:	75 ea                	jne    20 <main+0x20>
  36:	bb 30 00 00 00       	mov    $0x30,%ebx
        int pid = fork();
        if (pid == 0){
            char num = i + 48;
            char arg[1];
  ...
  3b:	8d 7d db             	lea    -0x25(%ebp),%edi
            exec("philsof", map_handler);
  3e:	8d 75 dc             	lea    -0x24(%ebp),%esi
        int pid = fork();
  ...
  4d:	80 fb 35             	cmp    $0x35,%bl
  50:	75 ef                	jne    41 <main+0x41>
        }
    }
    for (int i = 0 ; i < 5 ; i++) wait();
  52:	e8 a4 02 00 00       	call   2fb <wait>
  57:	e8 9f 02 00 00       	call   2fb <wait>
  5c:	e8 9a 02 00 00       	call   2fb <wait>
  61:	e8 95 02 00 00       	call   2fb <wait>
  66:	e8 90 02 00 00       	call   2fb <wait>
    exit();
  6b:	e8 83 02 00 00       	call   2f3 <exit>
            exec("philsof", map_handler);
  70:	83 ec 08             	sub    $0x8,%esp
            arg[0] = num;
  73:	88 5d db             	mov    %bl,-0x25(%ebp)
            exec("philsof", map_handler);
  76:	56                   	push   %esi
  77:	68 c8 07 00 00       	push   $0x7c8
            char *map_handler[] = {(char *) "philsof", arg, 0};
  7c:	c7 45 dc c8 07 00 00 	movl   $0x7c8,-0x24(%ebp)
  83:	89 7d e0             	mov    %edi,-0x20(%ebp)
  86:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
            exec("philsof", map_handler);
  8d:	e8 99 02 00 00       	call   32b <exec>
  92:	83 c4 10             	add    $0x10,%esp
  95:	eb b3                	jmp    4a <main+0x4a>
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
...
0000039b <get_parent_pid>:
 39b:	b8 17 00 00 00       	mov    $0x17,%eax
 3a0:	cd 40                	int    $0x40
 3a2:	c3                   	ret    

000003a3 <get_file_sectors>:
 3a3:	b8 18 00 00 00       	mov    $0x18,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret    

000003ab <set_process_parent>:
 3ab:	b8 19 00 00 00       	mov    $0x19,%eax
 3b0:	cd 40                	int    $0x40
 3b2:	c3                   	ret    

000003b3 <change_process_queue>:
 3b3:	b8 1a 00 00 00       	mov    $0x1a,%eax
 3b8:	cd 40                	int    $0x40
 3ba:	c3                   	ret    

000003bb <set_hrrn_priority>:
 3bb:	b8 1b 00 00 00       	mov    $0x1b,%eax
 3c0:	cd 40                	int    $0x40
 3c2:	c3                   	ret    

000003c3 <set_ptable_hrrn_priority>:
 3c3:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3c8:	cd 40                	int    $0x40
 3ca:	c3                   	ret    

000003cb <print_processes>:
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba d0 07 00 00       	mov    $0x7d0,%edx
        while(*s != 0){
